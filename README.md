...
|-------------	|--------------------------------------------------------------------------------------------------------------------------	|
| Bounce      	| flutter                                                                                                                  	|
| Yulu        	| android mapbox map my india, mmi payments - paytm, phonepe, payu moengage truecaller freshchat cognito, kinesis protobuf 	|
| Porter      	| android (customerapp) sentry razorypay aws, cognitoidentity, mobileanalytics google maps, mapbox, mmi                    	|
| Pharmeasy   	| reactnative & android appsflyer codepush truecaller                                                                      	|
| Groww       	| reactnative                                                                                                              	|
